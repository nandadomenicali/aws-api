## Criação da API
A API já está criada na pasta `aws-api`. As seguintes instruções são uma demonstração prática de como ela foi criada
...
# lb4 app
? Project name: aws-api
? Project description: Test API for AWS
? Project root directory: aws-api
? Application class name: AwsApplication
